...
if is_module_loaded(FILENAME):
    ...
    from Sangtei import GBAN_LOGS, log, dispatcher
    from Sangtei.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
...
@rencallback(pattern=r"log_tog_.*")
