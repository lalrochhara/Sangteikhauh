...
from Sangtei.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from Sangtei.modules.helper_funcs.extraction import extract_user
from Sangtei.modules.log_channel import gloggable
from Sangtei.modules.sql import nation_sql as sql
from Sangtei.modules.helper_funcs.decorators import rencmd
...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in SUPPORT_USERS:
        rt += "Requested Sangtei Union to promote a Support user to Sudo."
        SUPPORT_USERS.remove(user_id)

    if user_id in WHITELIST_USERS:
        rt += "Requested Sangtei Union to promote a Whitelist user to Sudo."
...
nations = """ Sangtei has bot access levels we call as *"Nation Levels"*
\n*Sangtei Union* - Devs who can access the bots server and can execute, edit, modify bot code. Can also manage other Nations
\n*God* - Only one exists, bot owner.
Owner has complete bot access, including bot adminship in chats Sangtei is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Hito.
\n*Sakuras* - Have access go globally ban users across Sangtei.
...
\n*Disclaimer*: The Nation levels in Sangtei are there for troubleshooting, support, banning potential scammers.
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Sangtei Union Members :</b>\n"
