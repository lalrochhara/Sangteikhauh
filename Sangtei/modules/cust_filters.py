...
from Sangtei import dispatcher, log, SUDO_USERS
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@rencmd(command="stop", run_async=False, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@renmsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@rencmd(command=["removeallfilters", "clearfilters"], filters=Filters.chat_type.groups)
...
@rencallback(pattern=r"filters_.*")
