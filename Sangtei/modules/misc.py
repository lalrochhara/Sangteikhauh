...
from Sangtei.__main__ import STATS, USER_INFO, TOKEN
from Sangtei.modules.sql import SESSION
from Sangtei.modules.helper_funcs.chat_status import user_admin, sudo_plus
from Sangtei.modules.helper_funcs.extraction import extract_user
import Sangtei.modules.sql.users_sql as sql
from Sangtei.modules.users import __user_info__ as chat_count
...
from pykillerx import __version__ as pykillerx
...
def stats(update, context):
    ...
    status += f"*• Pyrogram version:* {str(pyrover)}" + "\n"
    status += f"*• Telethon version:* {str(tlhver)}" + "\n"
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/lalrochhara/Sangtei) | [⍚ Dev](https://t.me/NickyLrca/)\n\n" +
