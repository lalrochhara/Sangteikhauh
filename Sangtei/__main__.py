# Copyright https://github.com/lalrochhara/Sangtei
# Create file by @NickyLrca
...
from Sangtei.modules.helper_funcs.decorators import rencmd, rencallback, renmsg
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="🔙", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url=f'https://t.me/SangteiSupport')]
                )
                send_help(
                    chat.id,
                    text,
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"Sangtei started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        SangteiINIT.bot_id = dispatcher.bot.id
        SangteiINIT.bot_username = dispatcher.bot.username
        SangteiINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    log.info("[Sangtei] Successfully loaded modules: " + str(ALL_MODULES))
